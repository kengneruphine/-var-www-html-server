    ...
    <form class="col s6 z-depth-2" action="" method="">
      ...
      <div class="row">
         <div class="col s2">.</div>
          ...
          <label  class="active" for="name"># of copies available</label>
        </div>
        </div> 
        ...
        <div class="row">
         <div class="col s2">.</div>
            <div class="input-field col s6">
             <input value="" id="name" type="date" class="validate">
         ...
         <div class="col s2">.</div>
           ...
           <div class="row">
              ...
              <div class="input-field col s3">
               <a href="#" class=" btn indigo darken-1" type="submit" name="action">Return</a>  
        </form>
        </div>
