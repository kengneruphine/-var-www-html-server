         ...
         <div class="col s2">.</div>
           ...
           <div class="row">
              ...
              <div class="input-field col s3">
               <button class=" btn indigo darken-1" type="submit" ng-disabled="myForm.book.$touched && myForm.book.$invalid || myForm.num.$touched && myForm.num.$invalid || myForm.dept.$touched && myForm.dept.$invalid" name="action">Remove</button>  
        </form>
        </div>
